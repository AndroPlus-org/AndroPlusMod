...
public class NotificationiconPatcher implements IXposedHookZygoteInit, IXposedHookLoadPackage {
	...
	public void hookScreenshotDelay(LoadPackageParam lpparam)
		{
		boolean isDelayRM = preference.getBoolean("key_remove_screenshot_delay", false);
		if(isDelayRM){
			try
			{
